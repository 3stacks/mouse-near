...
exports.default = function (target, callback) {
    ...
    var eventCallback = (0, _throttle2.default)(function (event) {
...
function calculateElementBounds(elementRect, options) {
    ...
    if (isNaN(distance)) {
        throw new TypeError('options.distance was expecting a number, was given: ' + (0, _typeof3.default)(options.distance));
    } else {
        return {
